...
import CFoodPresenter from './CFoodPresenter';
...
export default class extends React.Component {
  ...
  onListChanging = async () => {
    ...
    try {
      ...
      // console.log('Food China List : ' + JSON.stringify(listChanged));
      ...
      // console.log('Food China Locatoins : ' + JSON.stringify(locations));
    } catch (error) {
      console.log(error);
      error = "Cnat't get China FoodList";
    } finally {
      this.setState({
        loading: false,
        listChanged,
