...
import CampingPresenter from './CampingPresenter';
...
export default class extends React.Component {
  ...
  onListChanging = async () => {
    ...
    try {
      ...
      // console.log('Leisure Camping List : ' + JSON.stringify(listChanged));
      ...
      // console.log('Leisure Camping Locatoins : ' + JSON.stringify(locations));
    } catch (error) {
      console.log(error);
      error = "Cnat't get Camping";
    } finally {
      this.setState({
        loading: false,
