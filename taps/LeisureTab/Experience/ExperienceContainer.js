...
import ExperiencePresenter from './ExperiencePresenter';
...
export default class extends React.Component {
  ...
  onListChanging = async () => {
    ...
    try {
      ...
      // console.log('Leisure Experience List : ' + JSON.stringify(listChanged));
      ...
      // console.log('Leisure Experience Locatoins : ' + JSON.stringify(locations));
    } catch (error) {
      console.log(error);
      error = "Cnat't get Experience";
    } finally {
      this.setState({
        loading: false,
