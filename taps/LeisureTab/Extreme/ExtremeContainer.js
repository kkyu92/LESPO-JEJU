...
import ExtremePresenter from './ExtremePresenter';
...
export default class extends React.Component {
  ...
  onListChanging = async () => {
    ...
    try {
      ...
      // console.log('Leisure Extreme List : ' + JSON.stringify(listChanged));
      ...
      // console.log('Leisure Extreme Locatoins : ' + JSON.stringify(locations));
    } catch (error) {
      console.log(error);
      error = "Cnat't get Extreme";
    } finally {
      this.setState({
        loading: false,
