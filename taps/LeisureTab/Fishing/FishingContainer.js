...
import FishingPresenter from './FishingPresenter';
...
export default class extends React.Component {
  ...
  async componentDidMount() {
    ...
    try {
      ...
      // console.log('Leisure Fishing List : ' + JSON.stringify(listChanged));
      ...
      // console.log('Leisure Fishing Locatoins : ' + JSON.stringify(locations));
    } catch (error) {
      console.log(error);
      error = "Cnat't get Leisure Fishing";
    } finally {
      this.setState({
        loading: false,
