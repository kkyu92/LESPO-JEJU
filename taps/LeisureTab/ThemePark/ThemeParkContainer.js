...
import ThemeParkPresenter from './ThemeParkPresenter';
...
export default class extends React.Component {
  ...
  onListChanging = async () => {
    ...
    try {
      ...
      // console.log('Leisuer ThemePark List : ' + JSON.stringify(listChanged));
      ...
      // console.log('Leisure ThemePark Locatoins : ' + JSON.stringify(locations));
    } catch (error) {
      console.log(error);
      error = "Cnat't get ThemePark";
    } finally {
      this.setState({
        loading: false,
