...
import BowlingPresenter from './BowlingPresenter';
...
export default class extends React.Component {
  ...
  onListChanging = async () => {
    ...
    try {
      ...
      // console.log('Sports Bowling List : ' + JSON.stringify(listChanged));
      ...
      // console.log('Sports Bowling Locatoins : ' + JSON.stringify(locations));
    } catch (error) {
      console.log(error);
      error = "Cnat't get bowling";
    } finally {
      this.setState({
        loading: false,
