...
import FamousPresenter from './FamousPresenter';
...
export default class extends React.Component {
  ...
  async componentDidMount() {
    ...
    try {
      ...
      // console.log('View Famous List : ' + JSON.stringify(listChanged));
      ...
      // console.log('View Famous Locatoins : ' + JSON.stringify(locations));
    } catch (error) {
      console.log(error);
      error = "Cnat't get View Famous";
    } finally {
      this.setState({
        loading: false,
