...
import OlleGillPresenter from './OlleGillPresenter';
...
export default class extends React.Component {
  ...
  onListChanging = async () => {
    ...
    try {
      ...
      // console.log('View OlleGill List : ' + JSON.stringify(listChanged));
      ...
      // console.log('View OlleGill Locatoins : ' + JSON.stringify(locations));
    } catch (error) {
      console.log(error);
      error = "Cnat't get View OlleGill";
    } finally {
      this.setState({
        loading: false,
